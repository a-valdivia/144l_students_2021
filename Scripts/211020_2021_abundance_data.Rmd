...
In this document, bacterial abundance data from **individual bottles** in the 2021 Microbial DOC Remineralization Bioassay is processed, QC'd, and analyzed. This experiment includes four treatments (1) Control (2) Addition of Kelp Exudate (3) Addition of Kelp Exudate, Nitrate, Phosphate (4) Addition of Glucose, Nitrate, and Phosphate with two bottles for each treatment. The purpose of this experiment was to see how different treatments affect the bacterial populations.
